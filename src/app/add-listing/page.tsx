        ...
        <div className="container">
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              ...
              <h2 className="display-4 fw-bold mb-4">Why List Your Business on Kuwait Bizz?</h2>
            </div>
          </div>
            ...
            <div className="col-lg-10">
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-0" style={{ overflow: 'hidden', borderRadius: '4px' }}>
                  <iframe 
                    src="https://app.visionarybizz.com/widget/form/Hag7RIjaOnkdjqhIIQ70"
                    style={{ width: '100%', height: '870px', border: 'none' }}
                    id="inline-Hag7RIjaOnkdjqhIIQ70"
                    ...
                    data-height="870"
                    data-layout-iframe-id="inline-Hag7RIjaOnkdjqhIIQ70"
                    data-form-id="Hag7RIjaOnkdjqhIIQ70"
