...
export const footerLink1  = ['About KuwaitBizzDirectory','Submit Listing','KuwaitBizzDirectory Report','Careers']

export const footerLink2  = ['Trust & Safety','Investor Relations','Terms of Services','Paid Advertising','KuwaitBizzDirectory Blog']

export const footerLink3  = ['Trust & Safety','Investor Relations','Terms of Services','Paid Advertising','KuwaitBizzDirectory Blog']
