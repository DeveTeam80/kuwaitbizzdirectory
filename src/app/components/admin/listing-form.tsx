...
import { KUWAITI_CITIES, detectLocationContext, LocationDetectionResult } from '@/app/lib/location-detection'
...
export interface ListingFormData {
    ...
    // 🆕 New location fields
    locationConfirmation?: 'kuwait' | 'other'
}
...
export default function ListingForm({
    ...
    // 🔧 Fix: Check if initial city is in Kuwaiti cities list
    useEffect(() => {
        const cityFromData = initialData?.city
        if (cityFromData) {
            const isKuwaitiCity = KUWAITI_CITIES.slice(0, 10).some(
                city => city.toLowerCase() === cityFromData.toLowerCase()
            )
            setShowCustomCityInput(!isKuwaitiCity)
    ...
    const cityDropdownOptions = [
        ...KUWAITI_CITIES.slice(0, 10).map(city => ({ value: city, label: city })),
                                        ...
                                        {!showCustomCityInput ? (
                                            ...
                                            <>
                                                ...
                                                {locationDetection && cityInput && (
                                                    <>
                                                        {locationDetection.context === 'kuwait' && locationDetection.confidence === 'high' && (
                                                            <div className="alert alert-success mt-2 py-2 px-3 small">
                                                                <BsCheckCircle className="me-2" />
                                                                <strong>✓ Kuwait Location Detected</strong>
                                                        ...
                                                        {locationDetection.context === 'other' && locationDetection.confidence === 'high' && (
                                                            <div className="alert alert-warning mt-2 py-2 px-3 small">
                                                                ...
                                                                <p className="mb-0 mt-1">This listing will be marked as "Global" (outside Kuwait)</p>
                                                            </div>
                                                        )}
                                                        ...
                                                        {locationDetection.needsUserConfirmation && (
                                                            <div className="alert alert-info mt-2 py-2 px-3 small">
                                                                ...
                                                                <div className="mt-2">
                                                                    <label className="d-block mb-1 fw-semibold">Is this business located in Kuwait?</label>
                                                                    <div className="form-check form-check-inline">
                                                                        <input
                                                                            ...
                                                                            id="confirmKuwait"
                                                                            checked={formData.locationConfirmation === 'kuwait'}
                                                                            onChange={() => setFormData(prev => ({
                                                                                ...prev,
                                                                                locationConfirmation: 'kuwait'
                                                                            }))}
                                                                            required
                                                                        />
                                                                        <label className="form-check-label" htmlFor="confirmKuwait">
                                                                            ✓ Yes, in Kuwait
                                                                        </label>
                                                                    </div>
                                                                    <div className="form-check form-check-inline">
