                    ...
                    <div className="col-12 col-md-5 col-lg-12 col-xl-4">
                        <div className="footer-widget pe-xl-4 mb-5">
                            ...
                            {/* <div className="footerText">
                                <p>Kuwait Bizz is proudly managed by <Link href="https://visionarybizz.com/" target="_blank" className="text-light">Visionary Services</Link></p>
                            </div> */}
                                ...
                                <div className="singleinfo d-flex align-items-baseline">
                                    ...
                                    <div className="caps">
                                        <h5 className="title text-light">
                                            <a href="mailto:info@kuwaitbizzdirectory.com" className="text-light">info@kuwaitbizzdirectory.com</a>
                                        </h5>
